...
def get_tank_image_by_id(tank_id):
    ...
    return None
# --- NEW: Bonus Codes Data ---
def get_active_codes():
    # Note: These codes are updated frequently by Wargaming. 
    # These are currently reported as active/upcoming for 2025.
    codes = {
            ...
            if feed.entries:
                ...
                if latest_link != saved_link:
                    if saved_link is not None:
                        ...
                        # Properly escape for Markdown or fallback to standard
...
def start(message):
    ...
    markup.add(btn_tank, btn_compare, btn_player, btn_clan, btn_calc, btn_moe, btn_news, btn_codes)

    welcome_text = (
        "👋 *Welcome to Tank Assistant!*\n\n"
        "I can help you find tank stats, check player progress, manage your clan, and find the latest rewards.\n"
...
def handle_main_menu(call):
    ...
    # 6. NEW: BONUS CODES HANDLER
    elif call.data == "menu_codes":
        # Research-based active codes for 2024-2025
        response = (
    ...
    # 7. BACK BUTTON HANDLER
        ...
        # Re-trigger the start menu without sending a new message
